...
/** \mainpage RoboComp::ainf_mission_planner
 *
 * \section intro_sec Introduction
 *
 * The ainf_mission_planner component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/ainf_mission_planner --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "ainf_mission_planner"
#define SERVER_FULL_NAME   "RoboComp ainf_mission_planner::ainf_mission_planner"
...
class ainf_mission_planner : public Ice::Application
{
public:
	ainf_mission_planner (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData ainf_mission_planner::getInitializationDataIce(){
...
void ainf_mission_planner::initialize()
{
...
int ainf_mission_planner::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	ainf_mission_planner app(configFile, prefix, startup_check_flag);
