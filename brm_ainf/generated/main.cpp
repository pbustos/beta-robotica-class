...
/** \mainpage RoboComp::brm_ainf
 *
 * \section intro_sec Introduction
 *
 * The brm_ainf component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/brm_ainf --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "brm_ainf"
#define SERVER_FULL_NAME   "RoboComp brm_ainf::brm_ainf"
...
class brm_ainf : public Ice::Application
{
public:
	brm_ainf (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData brm_ainf::getInitializationDataIce(){
...
int brm_ainf::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	brm_ainf app(configFile, prefix, startup_check_flag);
