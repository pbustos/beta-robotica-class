...
/** \mainpage RoboComp::ainf_slamo
 *
 * \section intro_sec Introduction
 *
 * The ainf_slamo component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/ainf_slamo --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class ainf_slamo : public Ice::Application
{
public:
	ainf_slamo (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData ainf_slamo::getInitializationDataIce(){
...
int ainf_slamo::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	ainf_slamo app(configFile, prefix, startup_check_flag);
