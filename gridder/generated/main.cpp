...
class gridder : public Ice::Application
{
public:
	gridder (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData gridder::getInitializationDataIce(){
...
int gridder::run(int argc, char* argv[])
{
	...
	tprx = std::make_tuple(lidar3d_proxy,lidar3d_proxy1);
	...
	try
	{
		...
		//Implement code
		implement<GridderI>(communicator(),
		                    configLoader.get<std::string>("Endpoints.Gridder"), 
		                    "gridder", worker,  0);
...
int main(int argc, char* argv[])
{
	...
	gridder app(configFile, prefix, startup_check_flag);
