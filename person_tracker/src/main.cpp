...
/** \mainpage RoboComp::person_tracker
 *
 * \section intro_sec Introduction
 *
 * The person_tracker component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/person_tracker --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class person_tracker : public RoboComp::Application
{
public:
	person_tracker (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::person_tracker::initialize()
{
...
int ::person_tracker::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::person_tracker app(prefix, startup_check_flag);
