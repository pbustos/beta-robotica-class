...
## Dependencies
The following dependencies are required to build and run task1. Ensure they are installed and properly configured on your system before proceeding:
```
<YOUR DEPENDENCIES>
```

## Configuration parameters
Like any other component, task1 requires a configuration file to start. In etc/config or etc/config.toml, you can find an example of the configuration file.
...
bin/task1 etc/yourConfig # Execute the component
```
-----
-----
# Developer Notes
This section explains how to work with the generated code of task1, including what can be modified and how to use key features.
## Editable Files
